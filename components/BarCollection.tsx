  ...
  return (
    <div className="flex justify-between items-center mx-auto px-8 py-4">
      <div className="flex items-center gap-4">
        <div className="w-12 h-3 bg-surface"></div>
        <div className="flex flex-col items-baseline">
          <p className="font-bold text-lg text-text-primary">Colección:</p>
          <p className="font-bold text-text-title self-center">
            {collectionTitle}
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <select className="bg-gray-800 border border-gray-700 rounded-md p-1 text-sm">
